...
require (
	github.com/egoist/quickgui/extensions/editor v0.1.4-next.4
	github.com/egoist/quickgui/extensions/markdown v0.1.4-next.4
	github.com/egoist/quickgui/extensions/terminal v0.1.4-next.4
	github.com/egoist/quickgui/go v0.1.4-next.4
)
